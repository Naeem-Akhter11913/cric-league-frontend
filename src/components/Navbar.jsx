...
//                 isActive ? "text-[var(--color-text-onDark)]" : ""
//               }`}
//             >
//               {link}
//               {isActive && (
...
//         <button command="show-modal" commandfor="dialog" className="px-5 py-2 rounded-[var(--radius-sm)] border border-[var(--color-border-dark)] text-[var(--color-text-onDark)] text-sm font-semibold hover:bg-white/5 transition-colors">
//           Login
//         </button>
//         <button command="show-modal" commandfor="dialog" className="px-5 py-2 rounded-[var(--radius-sm)] grad-primary text-white text-sm font-semibold shadow-[0_4px_14px_rgba(124,92,252,0.4)] hover:brightness-110 transition">
//           Sign Up
//         </button>
//       </div>
//     </nav>
