...
import { useAppDispatch, useAppSelector } from '../store/hooks';
import { registerUser } from '../store/action/auth.action';
import { teamColors, allPlayers, stats, tabs } from '../data/orgPlayer.data';
...
const OrgPlayers = () => {
    ...
    const filteredList = allPlayers
        .filter((p) => (activeTab === "All Players" ? true : p.role === roleMap[activeTab]))
