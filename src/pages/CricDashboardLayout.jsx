...
import DashTournaments from './Dashboard';

// ---------- static data (mirrors the reference screenshot) ----------
...
const CricDashboard = () => {
    ...
    //     { label: "Live Scores", icon: Radio },
    //     { label: "Points Table", icon: Table2 },
    //     { label: "Statistics", icon: BarChart3 },
    //     // { label: "Venues", icon: MapPin },
    //     { label: "Scorers", icon: ClipboardList },
    ...
    const sidebarItems = [
        ...
        { label: "Tournaments", icon: Trophy, to: "/dashboard/tournaments" },
        { label: "Teams", icon: Users, to: "/dashboard/teams" },
        { label: "Players", icon: UserRound, to: "/dashboard/players" },
        { label: "Matches", icon: Swords, to: "/dashboard/matches" },
        { label: "Live Scores", icon: Radio, to: "/dashboard/live-scores" },
        { label: "Points Table", icon: Table2, to: "/dashboard/points-table" },
        { label: "Statistics", icon: BarChart3, to: "/dashboard/statistics" },
        { label: "Venues", icon: MapPin, to: "/dashboard/venues" },
        { label: "Scorers", icon: ClipboardList, to: "/dashboard/scorers" },
        // { label: "Reports", icon: FileText, to: "/dashboard/reports" },
        { label: "Notifications", icon: Bell, to: "/dashboard/notifications", badge: 8 },
    ...
    return (
        <div className="flex h-screen w-full border border-gray-400 relative overflow-hidden bg-[#F7F7F9]">
            ...
            >
                ...
                <div className="border-t border-[#E5E1D8] p-3 flex items-center gap-2">
