...
//           {/* Featured team cards — top 4 teams from the live team list */}
...
//           {/* All Teams table */}
//           <TeamsTables page={page} filteredList={filteredList} setPerPage
//             setPage={setPage} perPage={perPage}/>
//         </div>
//       </div>
//       <Modal
//         open={openModel}
    ...
    <>
      <div className="h-screen overflow-y-auto no-scrollbar bg-[#F7F7F9]">
        ...
        <div className="p-2 sm:p-6">
          ...
          {/* Featured team cards — top 4 teams from the live team list */}
          {/* Pass onEdit={handleOpenEdit} into TeamCard and wire it to the
              existing "Edit" item in its dropdown menu, e.g.:
              onClick={() => onEdit(team)} */}
          <TeamCard
            allTeamList={allTeamList}
            setOpenMenu={setOpenMenu}
          ...
          {/* All Teams table */}
          {/* Pass onEdit={handleOpenEdit} into TeamsTables and wire it to a
              row action (e.g. an Edit button/menu item next to Eye/MoreVertical),
              e.g.: onClick={() => onEdit(row)} */}
          <TeamsTables
            page={page}
