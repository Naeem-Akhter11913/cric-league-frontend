...
const Register = ({setModalPage}) => {
    ...
    return (
        <div className="h-full w-full max-h-[700px] bg-[#0a0a12] flex p-0 rounded-2xl overflow-hidden">
            {/* Left: branded panel */}
            <div className="hidden lg:flex w-[48%] relative overflow-hidden bg-gradient-to-br from-[#14102b] via-[#1a1030] to-[#0a0a12] items-center justify-center p-6">
                <div className="absolute -bottom-16 -left-16 w-64 h-64 rounded-full bg-violet-600/20 blur-3xl" />
                ...
                <div className="relative z-10 max-w-md">
                    ...
                    <div className="grid grid-cols-3 gap-3">
                        {[
                            ...
                            <div key={stat.label} className="rounded-2xl bg-black/40 border border-white/10 backdrop-blur px-4 py-3 text-center">
                                <p className="text-white font-extrabold text-lg">{stat.value}</p>
                                <p className="text-gray-500 text-xs mt-1">{stat.label}</p>
                            </div>
                        ))}
            ...
            {/* Right: form */}
            <div className="w-full lg:w-[52%] flex flex-col justify-center px-6 sm:px-10 py-6 overflow-y-auto">
                <div className="max-w-sm w-full mx-auto">
                    <h1 className="text-3xl font-extrabold text-white mb-2">Create your account</h1>
                    <p className="text-gray-400 mb-5">It's free — get started in under a minute.</p>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-3">
                        <div>
                            ...
                            <input
                                ...
                                onChange={update("name")}
                                placeholder="Your name"
                                className="w-full rounded-xl bg-white/5 border border-white/10 text-white placeholder-gray-500 px-4 py-2.5 outline-none focus:border-violet-500 focus:ring-1 focus:ring-violet-500 transition"
                            />
                        </div>
                        ...
                        <label className="flex items-start gap-2 text-sm text-gray-400 cursor-pointer select-none">
                            <input
                                ...
                                checked={form.agree}
                                onChange={update("agree")}
                                className="mt-0.5 rounded border-white/20 bg-white/5 text-violet-500 focus:ring-violet-500 focus:ring-offset-0 shrink-0"
                            />
                            <span>
                                I agree to the{" "}
                                <a href="/terms" className="text-violet-400 hover:text-violet-300">
