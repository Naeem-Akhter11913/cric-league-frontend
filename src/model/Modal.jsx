...
//     >
//       <div
//         className="max-h-[90vh] w-[70vw] overflow-y-auto rounded-2xl bg-white shadow-xl"
...
//     >
//       <div
//         className="max-h-[90vh] w-fit max-w-[95vw] overflow-y-auto rounded-2xl bg-white shadow-xl"
//         onClick={(e) => e.stopPropagation()}
//       >
//         {children}
//       </div>
...
//     >
//       <div
//         className="relative max-h-[90vh] w-fit max-w-[95vw] overflow-y-auto rounded-2xl bg-white shadow-xl scrollbar-hide"
//         onClick={(e) => e.stopPropagation()}
//       >
//         {/* Close Button */}
//         <button
//           type="button"
//           onClick={onClose}
//           className="absolute right-4 top-4 z-10 rounded-full p-1 text-gray-500 transition hover:bg-gray-100 hover:text-gray-700 cursor-pointer"
//         >
//           <X size={20} />
//         </button>
...
//         {/* Footer */}
//         <div className="absolute bottom-0 left-0 right-0 flex items-center justify-end gap-3 border-t bg-white px-6 py-4">
//           <button
//             type="button"
//             onClick={onClose}
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="z-20 flex shrink-0 items-center justify-end gap-3 px-2 py-2">
          <button
            type="button"
            onClick={onClose}
            className="rounded-lg border border-gray-300 px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 cursor-pointer"
